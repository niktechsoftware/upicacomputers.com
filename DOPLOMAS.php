...
<div class="main head-pat1">
			...
			<div id="portfolio">
				<div id="box_head">
						<div id="box_head_heading">
						  <h1 id="box_head_left">Diploma</h1>
						  <div id="box_head_sub">/DCA/PGDCA</div>
	...
	<input type='hidden' id='show_per_page' />
			...
			<div class="portfolio-big">
				<div class="portfolio-big-left">
					<div class="portfolio_single">
						<div class="portfolio_single_img">
							<a href="images/slider_image/slider1.jpg" rel="prettyPhoto[]" title="" class="papillon_image">
								<img src="images/portfolio_big.jpg" width="558" height="460" alt="" />
							</a>	
	
						</div>
						<div class="portfolio_single_img_small">
							<a href="images/slider_image/slider3.jpg" rel="prettyPhoto[]" title="" class="papillon_image">
								<img src="images/slider_image/rel2.jpg" width="179.33" height="120" alt="" />
							</a>
						</div>
						<div class="portfolio_single_img_small">
							<a href="images/slider_image/slider3.jpg" rel="prettyPhoto[]" title="" class="papillon_image">
						...
						<div class="portfolio_single_img_small_last">
							<a href="images/nivo1.jpg" rel="prettyPhoto[]" title="" class="papillon_image">
								<img src="images/slider_image/fs6.jpg" width="179.33" height="120" alt="" />
							</a>						
						</div>
			  ...
			  <h1>Diploma courses available at <span class="blueText">UPICA</span></h1>

					<div class="clear"></div>
					
					<p>Diploma courses which can be opted for are as below:-</p>

					
<div id="related_p">
						<h4 class="bottom_margin">Diplomas:</h4>
						<div class="relatedp_block">
							<ul class="checklist portfolio_chklist">
								<li><a href="PGDCA (Business Administration).php">PGDCA (BUSINESS ADMINISTRATION)</li>	
								<li><a href="PGDCA (Computer Application).php">PGDCA (COMPUTER APPLICATION)</li>
								<li><a href="DCA.php">DCA</li>
								<li><a href="ADCA.php">ADCA</li>
							    <li><a href="Polytechnic.php">POLYTECHNIC</li>
						  </ul>
						  <div class="clear"></div>
						</div>
			  </div>
